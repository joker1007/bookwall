...
CREATE TABLE IF NOT EXISTS "collections" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "name" varchar NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_9b33697360"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
...
CREATE TABLE IF NOT EXISTS "collection_books" ("collection_id" integer NOT NULL, "book_id" integer NOT NULL, "created_at" datetime(6) NOT NULL, PRIMARY KEY ("collection_id", "book_id"), CONSTRAINT "fk_rails_7e3dc44ded"
