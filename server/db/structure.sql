...
CREATE UNIQUE INDEX "index_api_tokens_on_token_digest" ON "api_tokens" ("token_digest");
...
CREATE INDEX "index_series_on_library_id" ON "series" ("library_id");
CREATE UNIQUE INDEX "index_series_on_library_id_and_name" ON "series" ("library_id", "name");
...
CREATE INDEX "index_book_authors_on_author_id_only" ON "book_authors" ("author_id");
...
CREATE INDEX "index_book_tags_on_book_id" ON "book_tags" ("book_id");
CREATE INDEX "index_book_tags_on_tag_id" ON "book_tags" ("tag_id");
CREATE INDEX "index_book_tags_on_tag_id_only" ON "book_tags" ("tag_id");
...
CREATE INDEX "index_favorites_on_book_id" ON "favorites" ("book_id");
CREATE INDEX "index_favorites_on_book_id_only" ON "favorites" ("book_id");
...
CREATE INDEX "index_scan_logs_on_library_id" ON "scan_logs" ("library_id");
...
CREATE UNIQUE INDEX "index_libraries_on_name" ON "libraries" ("name");
CREATE UNIQUE INDEX "index_libraries_on_path" ON "libraries" ("path");
CREATE INDEX "index_libraries_on_owner_id" ON "libraries" ("owner_id");
...
CREATE INDEX "index_library_shares_on_library_id" ON "library_shares" ("library_id");
CREATE INDEX "index_library_shares_on_user_id" ON "library_shares" ("user_id");
