...
CREATE TABLE "api_tokens" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "name" varchar NOT NULL, "token_digest" varchar NOT NULL, "token" varchar, "last_used_at" datetime(6), "expires_at" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_f16b5e0447"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
...
CREATE TABLE "series" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "library_id" integer NOT NULL, "name" varchar NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_c0fe7a0cad"
...
CREATE TABLE "authors" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
CREATE UNIQUE INDEX "index_authors_on_name" ON "authors" ("name") /*application='Bookwall'*/;
CREATE TABLE "tags" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
CREATE UNIQUE INDEX "index_tags_on_name" ON "tags" ("name") /*application='Bookwall'*/;
CREATE TABLE "books" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "library_id" integer NOT NULL, "series_id" integer, "title" varchar NOT NULL, "volume" integer, "file_path" varchar NOT NULL, "file_format" integer NOT NULL, "file_size" bigint DEFAULT 0 NOT NULL, "page_count" integer, "published_at" date, "added_at" datetime(6) NOT NULL, "scanned_at" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_9bb3dacd9b"
FOREIGN KEY ("library_id")
  REFERENCES "libraries" ("id")
...
CREATE TABLE "book_authors" ("book_id" integer NOT NULL, "author_id" integer NOT NULL, PRIMARY KEY ("book_id", "author_id"), CONSTRAINT "fk_rails_b23f3934c1"
FOREIGN KEY ("book_id")
  REFERENCES "books" ("id")
...
CREATE TABLE "book_tags" ("book_id" integer NOT NULL, "tag_id" integer NOT NULL, PRIMARY KEY ("book_id", "tag_id"), CONSTRAINT "fk_rails_a7d4b3652c"
FOREIGN KEY ("book_id")
  REFERENCES "books" ("id")
...
CREATE TABLE "favorites" ("user_id" integer NOT NULL, "book_id" integer NOT NULL, "created_at" datetime(6) NOT NULL, PRIMARY KEY ("user_id", "book_id"), CONSTRAINT "fk_rails_d15744e438"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
...
CREATE TABLE 'books_fts_content'(id INTEGER PRIMARY KEY, c0, c1, c2);
CREATE TABLE 'books_fts_docsize'(id INTEGER PRIMARY KEY, sz BLOB);
CREATE TABLE 'books_fts_config'(k PRIMARY KEY, v) WITHOUT ROWID;
CREATE TABLE "reading_progresses" ("user_id" integer NOT NULL, "book_id" integer NOT NULL, "current_page" integer DEFAULT 0 NOT NULL, "last_read_at" datetime(6) NOT NULL, "settings_json" text, "epub_cfi" varchar, "progress_fraction" float, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, PRIMARY KEY ("user_id", "book_id"), CONSTRAINT "fk_rails_063fbcdc58"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
...
CREATE TABLE "user_preferences" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "reader_spread" boolean, "reader_direction" varchar, "reader_scale" varchar, "reader_preload_ahead" integer, "reader_font_size" integer, "reader_theme" varchar, "reader_writing_mode" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_a69bfcfd81"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
CREATE UNIQUE INDEX "index_user_preferences_on_user_id" ON "user_preferences" ("user_id") /*application='Bookwall'*/;
CREATE TABLE "libraries" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "path" varchar NOT NULL, "last_scanned_at" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "owner_id" integer NOT NULL, "auto_scan_enabled" boolean DEFAULT TRUE NOT NULL /*application='Bookwall'*/, "deleting_at" datetime(6) /*application='Bookwall'*/, CONSTRAINT "fk_rails_3c26848d46"
...
CREATE TABLE "library_shares" ("library_id" integer NOT NULL, "user_id" integer NOT NULL, "created_at" datetime(6) NOT NULL, PRIMARY KEY ("library_id", "user_id"), CONSTRAINT "fk_rails_48f45bbd77"
FOREIGN KEY ("library_id")
  REFERENCES "libraries" ("id")
, CONSTRAINT "fk_rails_5294180c27"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
CREATE INDEX "index_library_shares_on_library_id" ON "library_shares" ("library_id") /*application='Bookwall'*/;
CREATE INDEX "index_library_shares_on_user_id" ON "library_shares" ("user_id") /*application='Bookwall'*/;
CREATE INDEX "index_library_shares_on_user_id_only" ON "library_shares" ("user_id") /*application='Bookwall'*/;
CREATE TABLE "collections" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "name" varchar NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_9b33697360"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
);
CREATE INDEX "index_collections_on_user_id" ON "collections" ("user_id") /*application='Bookwall'*/;
CREATE UNIQUE INDEX "index_collections_on_user_id_and_name" ON "collections" ("user_id", "name") /*application='Bookwall'*/;
CREATE TABLE "collection_books" ("collection_id" integer NOT NULL, "book_id" integer NOT NULL, "created_at" datetime(6) NOT NULL, PRIMARY KEY ("collection_id", "book_id"), CONSTRAINT "fk_rails_7e3dc44ded"
FOREIGN KEY ("collection_id")
  REFERENCES "collections" ("id")
, CONSTRAINT "fk_rails_598a9a6ca5"
FOREIGN KEY ("book_id")
  REFERENCES "books" ("id")
);
...
CREATE TABLE "scheduled_task_settings" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "daily_scan_enabled" boolean DEFAULT TRUE NOT NULL, "cleanup_enabled" boolean DEFAULT TRUE NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
CREATE TABLE "registration_settings" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "public_registration_enabled" boolean DEFAULT FALSE NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
